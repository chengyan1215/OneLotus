...
namespace QJY.API
{
    public class AliyunAPI
    {
        ...
        /// </summary>
        public string AccessKeyId { get; set; } = ConfigurationManager.AppSettings["accessKeyId"];
        ...
        public AliyunAPI(HttpMethod httpMethod, Dictionary<string, string> parameters)
        {
